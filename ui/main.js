...
var author$project$Channel$Channel = F3(
	function (name, id, metadata) {
		return {id: id, metadata: metadata, name: name};
	});
var author$project$JsonMF$ValueNull = {$: 'ValueNull'};
var elm$core$Maybe$Just = function (a) {
	return {$: 'Just', a: a};
};
var author$project$Channel$emptyChannel = A3(
	author$project$Channel$Channel,
	elm$core$Maybe$Just(''),
	'',
	elm$core$Maybe$Just(author$project$JsonMF$ValueNull));
var author$project$Channel$query = {limit: 10, offset: 0};
...
var author$project$Channel$initial = {
	channel: author$project$Channel$emptyChannel,
	channels: {list: _List_Nil, total: 0},
	editModalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$hidden,
	editMode: false,
	limit: author$project$Channel$query.limit,
	metadata: '',
	name: '',
	offset: author$project$Channel$query.offset,
	provisionModalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$hidden,
	response: ''
};
var author$project$Thing$Thing = F4(
	function (name, id, key, metadata) {
		return {id: id, key: key, metadata: metadata, name: name};
	});
var author$project$Thing$emptyThing = A4(
	author$project$Thing$Thing,
	elm$core$Maybe$Just(''),
	'',
	'',
	elm$core$Maybe$Just(author$project$JsonMF$ValueNull));
var author$project$Thing$query = {limit: 10, offset: 0};
var author$project$Thing$initial = {
	editModalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$hidden,
	editMode: false,
	limit: author$project$Thing$query.limit,
	location: '',
	metadata: '',
	name: '',
	offset: author$project$Thing$query.offset,
	provisionModalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$hidden,
	response: '',
	thing: author$project$Thing$emptyThing,
	things: {list: _List_Nil, total: 0}
};
var author$project$Connection$initial = {channels: author$project$Channel$initial, checkedChannelsIds: _List_Nil, checkedThingsIds: _List_Nil, response: '', things: author$project$Thing$initial, websocketIn: _List_Nil};
var author$project$Main$Model = F8(
	function (key, user, dashboard, channel, thing, connection, message, view) {
		return {channel: channel, connection: connection, dashboard: dashboard, key: key, message: message, thing: thing, user: user, view: view};
	});
...
var author$project$Message$initial = {channels: author$project$Channel$initial, checkedChannelsIds: _List_Nil, checkedChannelsIdsWs: _List_Nil, message: '', response: '', thingid: '', thingkey: '', things: author$project$Thing$initial, websocketIn: _List_Nil};
...
var author$project$User$initial = {dropState: rundis$elm_bootstrap$Bootstrap$Dropdown$initialState, email: '', password: '', response: '', token: ''};
var author$project$Version$initial = {version: ''};
	...
	function (_n0, url, key) {
		return _Utils_Tuple2(
			A8(
				...
				key,
				author$project$User$initial,
				author$project$Version$initial,
				author$project$Channel$initial,
				author$project$Thing$initial,
				author$project$Connection$initial,
				author$project$Message$initial,
				author$project$Main$parse(url)),
			elm$core$Platform$Cmd$none);
	});
var author$project$Main$MessageMsg = function (a) {
	return {$: 'MessageMsg', a: a};
};
var author$project$Main$UserMsg = function (a) {
	return {$: 'UserMsg', a: a};
};
var author$project$Message$RetrievedWebsockets = function (a) {
	return {$: 'RetrievedWebsockets', a: a};
};
var author$project$Message$WebsocketIn = function (a) {
	return {$: 'WebsocketIn', a: a};
};
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$Ports$retrieveWebsockets = _Platform_incomingPort('retrieveWebsockets', elm$json$Json$Decode$value);
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Ports$websocketIn = _Platform_incomingPort('websocketIn', elm$json$Json$Decode$string);
var elm$core$Platform$Sub$batch = _Platform_batch;
var author$project$Message$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Ports$websocketIn(author$project$Message$WebsocketIn),
				author$project$Ports$retrieveWebsockets(author$project$Message$RetrievedWebsockets)
			]));
};
var author$project$User$DropState = function (a) {
	return {$: 'DropState', a: a};
};
...
var author$project$User$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(rundis$elm_bootstrap$Bootstrap$Dropdown$subscriptions, model.dropState, author$project$User$DropState)
			]));
};
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				author$project$User$subscriptions(model.user)),
				A2(
				elm$core$Platform$Sub$map,
				author$project$Main$MessageMsg,
				author$project$Message$subscriptions(model.message))
			]));
};
var author$project$Channel$RetrieveChannels = {$: 'RetrieveChannels'};
var author$project$Connection$ChannelMsg = function (a) {
	return {$: 'ChannelMsg', a: a};
};
var author$project$Connection$ThingMsg = function (a) {
	return {$: 'ThingMsg', a: a};
};
var author$project$Channel$ProvisionedChannel = function (a) {
	return {$: 'ProvisionedChannel', a: a};
};
var author$project$Channel$RemovedChannel = function (a) {
	return {$: 'RemovedChannel', a: a};
};
var author$project$Channel$RetrievedChannel = function (a) {
	return {$: 'RetrievedChannel', a: a};
};
var author$project$Channel$RetrievedChannels = function (a) {
	return {$: 'RetrievedChannels', a: a};
};
var author$project$Channel$UpdatedChannel = function (a) {
	return {$: 'UpdatedChannel', a: a};
};
var author$project$JsonMF$ValueArray = function (a) {
	return {$: 'ValueArray', a: a};
};
var author$project$JsonMF$ValueBool = function (a) {
	return {$: 'ValueBool', a: a};
};
var author$project$JsonMF$ValueFloat = function (a) {
	return {$: 'ValueFloat', a: a};
};
var author$project$JsonMF$ValueInt = function (a) {
	return {$: 'ValueInt', a: a};
};
var author$project$JsonMF$ValueObject = function (a) {
	return {$: 'ValueObject', a: a};
};
var author$project$JsonMF$ValueString = function (a) {
	return {$: 'ValueString', a: a};
};
...
function author$project$JsonMF$cyclic$jsonValueDecoder() {
	return elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2(
				elm$json$Json$Decode$map,
				author$project$JsonMF$ValueObject,
				elm$json$Json$Decode$keyValuePairs(
					elm$json$Json$Decode$lazy(
						function (_n0) {
							return author$project$JsonMF$cyclic$jsonValueDecoder();
						}))),
				A2(
				elm$json$Json$Decode$map,
				author$project$JsonMF$ValueArray,
				elm$json$Json$Decode$list(
					elm$json$Json$Decode$lazy(
						function (_n1) {
							return author$project$JsonMF$cyclic$jsonValueDecoder();
						}))),
				A2(elm$json$Json$Decode$map, author$project$JsonMF$ValueInt, elm$json$Json$Decode$int),
				A2(elm$json$Json$Decode$map, author$project$JsonMF$ValueFloat, elm$json$Json$Decode$float),
				A2(elm$json$Json$Decode$map, author$project$JsonMF$ValueBool, elm$json$Json$Decode$bool),
				A2(elm$json$Json$Decode$map, author$project$JsonMF$ValueString, elm$json$Json$Decode$string),
				A2(
				elm$json$Json$Decode$map,
				function (_n2) {
					return author$project$JsonMF$ValueNull;
				},
				elm$json$Json$Decode$null(''))
			]));
}
try {
	var author$project$JsonMF$jsonValueDecoder = author$project$JsonMF$cyclic$jsonValueDecoder();
	author$project$JsonMF$cyclic$jsonValueDecoder = function () {
		return author$project$JsonMF$jsonValueDecoder;
	};
} catch ($) {
throw 'Some top-level definitions from `JsonMF` are causing infinite recursion:\n\n  ┌─────┐\n  │    jsonValueDecoder\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.0/halting-problem to learn how to fix it!';}
...
var author$project$Channel$channelDecoder = A4(
	...
	elm$json$Json$Decode$maybe(
		A2(elm$json$Json$Decode$field, 'metadata', author$project$JsonMF$jsonValueDecoder)));
var author$project$Helpers$parseString = function (str) {
	if (str.$ === 'Just') {
		var s = str.a;
		return s;
	} else {
...
var author$project$JsonMF$jsonValueEncoder = function (json) {
	switch (json.$) {
		case 'ValueObject':
			var dict = json.a;
			return elm$json$Json$Encode$object(
				A2(
					...
					function (_n1) {
						...
						return _Utils_Tuple2(
							k,
							author$project$JsonMF$jsonValueEncoder(v));
					},
					dict));
		case 'ValueArray':
			var array = json.a;
			return A2(elm$json$Json$Encode$list, author$project$JsonMF$jsonValueEncoder, array);
		case 'ValueString':
			var str = json.a;
			return elm$json$Json$Encode$string(str);
		case 'ValueFloat':
			var number = json.a;
			return elm$json$Json$Encode$float(number);
		case 'ValueInt':
			var number = json.a;
			return elm$json$Json$Encode$int(number);
		case 'ValueBool':
			var bool = json.a;
...
var author$project$JsonMF$maybeJsonValueToJsonValue = function (maybeJsonValue) {
	if (maybeJsonValue.$ === 'Just') {
		var jsonValue = maybeJsonValue.a;
		return jsonValue;
	} else {
		return author$project$JsonMF$ValueNull;
	}
};
var author$project$Channel$channelEncoder = function (channel) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				elm$json$Json$Encode$string(
					author$project$Helpers$parseString(channel.name))),
				_Utils_Tuple2(
				'metadata',
				author$project$JsonMF$jsonValueEncoder(
					author$project$JsonMF$maybeJsonValueToJsonValue(channel.metadata)))
			]));
};
var author$project$Channel$Channels = F2(
	function (list, total) {
		return {list: list, total: total};
	});
var author$project$Channel$channelsDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Channel$Channels,
	A2(
		elm$json$Json$Decode$field,
		'channels',
		elm$json$Json$Decode$list(author$project$Channel$channelDecoder)),
	A2(elm$json$Json$Decode$field, 'total', elm$json$Json$Decode$int));
var author$project$Channel$resetEdit = function (model) {
...
var author$project$Helpers$buildQueryParamList = F2(
	function (offset, limit) {
		return _List_fromArray(
			[
				A2(elm$url$Url$Builder$int, 'offset', offset),
				A2(elm$url$Url$Builder$int, 'limit', limit)
			]);
	});
var author$project$HttpMF$paths = {channels: 'channels', messages: 'messages', req: 'req', res: 'res', things: 'things', tokens: 'tokens', users: 'users', version: 'version'};
var author$project$Env$env = {url: ''};
var author$project$HttpMF$baseURL = author$project$Env$env.url;
...
var author$project$HttpMF$expectRetrieve = F2(
...
var author$project$HttpMF$retrieve = F4(
	function (path, token, msg, decoder) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$emptyBody,
				expect: A2(author$project$HttpMF$expectRetrieve, msg, decoder),
				...
				url: _Utils_ap(author$project$HttpMF$baseURL, path)
			});
	});
...
var author$project$Channel$updateChannelList = F2(
		...
		return _Utils_Tuple2(
			...
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A4(
						author$project$HttpMF$retrieve,
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.channels]),
							A2(author$project$Helpers$buildQueryParamList, model.offset, model.limit)),
						token,
						author$project$Channel$RetrievedChannels,
						author$project$Channel$channelsDecoder),
						A4(
						author$project$HttpMF$retrieve,
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.channels, model.channel.id]),
							_List_Nil),
						token,
						author$project$Channel$RetrievedChannel,
						author$project$Channel$channelDecoder)
					])));
	});
var author$project$Error$handle = function (error) {
	switch (error.$) {
		case 'BadUrl':
			var url = error.a;
			return 'Bad URL: ' + url;
...
var author$project$Helpers$pageToOffset = F2(
	function (page, limit) {
		return (page - 1) * limit;
	});
var elm$core$Basics$ge = _Utils_ge;
var author$project$Helpers$validateOffset = F3(
	function (offset, total, limit) {
		return (_Utils_cmp(offset, total - 1) > -1) ? A2(elm$core$Basics$max, (total - 1) - limit, 0) : offset;
	});
var author$project$HttpMF$expectID = F2(
	function (toMsg, prefix) {
		return A2(
			elm$http$Http$expectStringResponse,
			toMsg,
			function (resp) {
					...
					default:
						...
						return elm$core$Result$Ok(
							A2(
								...
								author$project$Helpers$parseString(
									A2(elm$core$Dict$get, 'location', metadata.headers))));
				}
			});
	});
...
var author$project$HttpMF$provision = F6(
	function (path, token, e, encoder, msg, prefix) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$jsonBody(
					encoder(e)),
				expect: A2(author$project$HttpMF$expectID, msg, prefix),
				headers: _List_fromArray(
					[
						A2(elm$http$Http$header, 'Authorization', token)
					]),
...
var author$project$HttpMF$expectStatus = function (toMsg) {
	return A2(
		elm$http$Http$expectStringResponse,
		toMsg,
		function (resp) {
			switch (resp.$) {
				...
				default:
					var metadata = resp.a;
					return elm$core$Result$Ok(
						elm$core$String$fromInt(metadata.statusCode));
			}
		});
};
var author$project$HttpMF$remove = F3(
	function (path, token, msg) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$emptyBody,
				expect: author$project$HttpMF$expectStatus(msg),
				headers: _List_fromArray(
					[
						A2(elm$http$Http$header, 'Authorization', token)
					]),
...
var author$project$HttpMF$update = F5(
	function (path, token, e, encoder, msg) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$jsonBody(
					encoder(e)),
...
var author$project$JsonMF$jsonValueToString = function (jsonValue) {
	return A2(
		elm$json$Json$Encode$encode,
		1,
		author$project$JsonMF$jsonValueEncoder(jsonValue));
};
var author$project$JsonMF$maybeJsonValueToString = function (maybeJsonValue) {
	return author$project$JsonMF$jsonValueToString(
		author$project$JsonMF$maybeJsonValueToJsonValue(maybeJsonValue));
};
var author$project$JsonMF$stringToJsonValue = function (jsonString) {
	return A2(elm$json$Json$Decode$decodeString, author$project$JsonMF$jsonValueDecoder, jsonString);
};
var author$project$JsonMF$stringToMaybeJsonValue = function (string) {
	var _n0 = author$project$JsonMF$stringToJsonValue(string);
	if (_n0.$ === 'Ok') {
		var jsonValue = _n0.a;
		return elm$core$Maybe$Just(jsonValue);
	} else {
		var err = _n0.a;
		return elm$core$Maybe$Just(author$project$JsonMF$ValueNull);
	}
};
...
var author$project$Channel$update = F3(
	function (msg, model, token) {
		switch (msg.$) {
			...
			case 'SubmitPage':
				var page = msg.a;
				return A2(
					author$project$Channel$updateChannelList,
					_Utils_update(
						model,
						{
							offset: A2(author$project$Helpers$pageToOffset, page, author$project$Channel$query.limit)
						}),
					token);
			case 'SubmitMetadata':
				var metadata = msg.a;
			...
			case 'ProvisionChannel':
				return _Utils_Tuple2(
					author$project$Channel$resetEdit(model),
					A6(
						author$project$HttpMF$provision,
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.channels]),
						...
						token,
						_Utils_update(
							author$project$Channel$emptyChannel,
							{
								metadata: author$project$JsonMF$stringToMaybeJsonValue(model.metadata),
								name: elm$core$Maybe$Just(model.name)
							}),
						author$project$Channel$channelEncoder,
						author$project$Channel$ProvisionedChannel,
						'/channels/'));
			case 'ProvisionedChannel':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var channelid = result.a;
					return A2(
						author$project$Channel$updateChannelList,
						_Utils_update(
							model,
							{
								channel: _Utils_update(
									author$project$Channel$emptyChannel,
									{id: channelid}),
								editModalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$shown,
								provisionModalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$hidden
							}),
						token);
				} else {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								response: author$project$Error$handle(error)
							}),
						elm$core$Platform$Cmd$none);
				}
			case 'EditChannel':
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							editMode: true,
							metadata: author$project$JsonMF$maybeJsonValueToString(model.channel.metadata),
							name: author$project$Helpers$parseString(model.channel.name)
						}),
					elm$core$Platform$Cmd$none);
			case 'UpdateChannel':
				return _Utils_Tuple2(
					author$project$Channel$resetEdit(
						_Utils_update(
							model,
							{editMode: false})),
					A5(
						author$project$HttpMF$update,
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.channels, model.channel.id]),
						...
						_Utils_update(
							...
							{
								metadata: function () {
									var _n2 = author$project$JsonMF$stringToJsonValue(model.metadata);
									if (_n2.$ === 'Ok') {
										var jsonValue = _n2.a;
										return elm$core$Maybe$Just(jsonValue);
									} else {
										var err = _n2.a;
										return model.channel.metadata;
									}
								}(),
								name: elm$core$Maybe$Just(model.name)
							}),
						author$project$Channel$channelEncoder,
						author$project$Channel$UpdatedChannel));
			case 'UpdatedChannel':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var statusCode = result.a;
					return A2(
						author$project$Channel$updateChannelList,
						author$project$Channel$resetEdit(
							_Utils_update(
				...
				return _Utils_Tuple2(
					...
					A4(
						...
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.channels, channelid]),
							_List_Nil),
						token,
						author$project$Channel$RetrievedChannel,
						author$project$Channel$channelDecoder));
			case 'RetrievedChannel':
				var result = msg.a;
				if (result.$ === 'Ok') {
				...
				return _Utils_Tuple2(
					...
					A4(
						...
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.things, thingid, author$project$HttpMF$paths.channels]),
							A2(author$project$Helpers$buildQueryParamList, model.offset, model.limit)),
						token,
						author$project$Channel$RetrievedChannels,
						author$project$Channel$channelsDecoder));
			case 'RetrievedChannels':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var channels = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{channels: channels}),
			...
			case 'RemoveChannel':
				...
				return _Utils_Tuple2(
					author$project$Channel$resetEdit(model),
					A3(
						author$project$HttpMF$remove,
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.channels, id]),
							_List_Nil),
						token,
						author$project$Channel$RemovedChannel));
			case 'RemovedChannel':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var statusCode = result.a;
					return A2(
						...
						_Utils_update(
							...
							{
								editModalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$hidden,
								offset: A3(author$project$Helpers$validateOffset, model.offset, model.channels.total, author$project$Channel$query.limit),
								response: statusCode
							}),
						token);
				} else {
			...
			case 'ShowEditModal':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{channel: channel, editModalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$shown, editMode: false}),
					elm$core$Platform$Cmd$none);
			case 'CloseEditModal':
				return _Utils_Tuple2(
					author$project$Channel$resetEdit(
						_Utils_update(
							...
							{editModalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$hidden})),
					elm$core$Platform$Cmd$none);
			case 'ShowProvisionModal':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{provisionModalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$shown}),
					elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					author$project$Channel$resetEdit(
...
var author$project$Main$ChannelMsg = function (a) {
	return {$: 'ChannelMsg', a: a};
};
var elm$core$Platform$Cmd$map = _Platform_map;
var author$project$Main$updateChannel = F2(
	function (model, msg) {
		var _n0 = A3(author$project$Channel$update, msg, model.channel, model.user.token);
		var updatedChannel = _n0.a;
		var channelCmd = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{channel: updatedChannel}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$ChannelMsg, channelCmd));
	});
var author$project$Connection$GotResponse = function (a) {
	return {$: 'GotResponse', a: a};
};
var author$project$HttpMF$request = F5(
	function (path, method, token, b, msg) {
		return elm$http$Http$request(
			{
				body: b,
				expect: author$project$HttpMF$expectStatus(msg),
...
var author$project$Connection$connect = F4(
	function (checkedThingsIds, checkedChannelsIds, method, token) {
		return A3(
			elm$core$List$foldr,
			...
			A2(
				...
				function (thingid) {
					return A2(
						...
						function (channelid) {
							return A5(
								author$project$HttpMF$request,
								A2(
									elm$url$Url$Builder$relative,
									_List_fromArray(
										[author$project$HttpMF$paths.channels, channelid, author$project$HttpMF$paths.things, thingid]),
									_List_Nil),
								method,
								token,
								elm$http$Http$emptyBody,
								author$project$Connection$GotResponse);
						},
						checkedChannelsIds);
				},
				checkedThingsIds));
...
var author$project$Connection$isEmptyChecked = function (model) {
	return elm$core$List$isEmpty(model.checkedThingsIds) || elm$core$List$isEmpty(model.checkedChannelsIds);
};
var author$project$Connection$resetChecked = function (model) {
	return _Utils_update(
		model,
		{checkedChannelsIds: _List_Nil, checkedThingsIds: _List_Nil});
};
...
var author$project$Helpers$checkEntity = F2(
	function (id, checkedEntitiesIds) {
		return A2(elm$core$List$member, id, checkedEntitiesIds) ? A2(elm_community$list_extra$List$Extra$remove, id, checkedEntitiesIds) : A2(elm$core$List$cons, id, checkedEntitiesIds);
	});
var author$project$Thing$ProvisionedThing = function (a) {
	return {$: 'ProvisionedThing', a: a};
};
var author$project$Thing$RemovedThing = function (a) {
	return {$: 'RemovedThing', a: a};
};
var author$project$Thing$RetrievedThing = function (a) {
	return {$: 'RetrievedThing', a: a};
};
var author$project$Thing$RetrievedThings = function (a) {
	return {$: 'RetrievedThings', a: a};
};
var author$project$Thing$UpdatedThing = function (a) {
	return {$: 'UpdatedThing', a: a};
};
var author$project$Thing$resetEdit = function (model) {
	return _Utils_update(
		model,
		{metadata: '', name: ''});
};
var elm$json$Json$Decode$map4 = _Json_map4;
var author$project$Thing$thingDecoder = A5(
	...
	elm$json$Json$Decode$maybe(
		A2(elm$json$Json$Decode$field, 'metadata', author$project$JsonMF$jsonValueDecoder)));
var author$project$Thing$thingEncoder = function (thing) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'name',
				elm$json$Json$Encode$string(
					author$project$Helpers$parseString(thing.name))),
				_Utils_Tuple2(
				'metadata',
				author$project$JsonMF$jsonValueEncoder(
					author$project$JsonMF$maybeJsonValueToJsonValue(thing.metadata)))
			]));
};
var author$project$Thing$Things = F2(
	function (list, total) {
		return {list: list, total: total};
	});
var author$project$Thing$thingsDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Thing$Things,
	A2(
		elm$json$Json$Decode$field,
		'things',
		elm$json$Json$Decode$list(author$project$Thing$thingDecoder)),
	A2(elm$json$Json$Decode$field, 'total', elm$json$Json$Decode$int));
var author$project$Thing$updateThingList = F2(
	function (model, token) {
		return _Utils_Tuple2(
			model,
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.things]),
							A2(author$project$Helpers$buildQueryParamList, model.offset, model.limit)),
						token,
						author$project$Thing$RetrievedThings,
						author$project$Thing$thingsDecoder),
						A4(
						author$project$HttpMF$retrieve,
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.things, model.thing.id]),
							_List_Nil),
						token,
						author$project$Thing$RetrievedThing,
						author$project$Thing$thingDecoder)
					])));
	});
var author$project$Thing$update = F3(
	function (msg, model, token) {
		switch (msg.$) {
			case 'SubmitName':
				var name = msg.a;
			...
			case 'SubmitPage':
				var page = msg.a;
				return A2(
					author$project$Thing$updateThingList,
					_Utils_update(
						model,
						{
							offset: A2(author$project$Helpers$pageToOffset, page, author$project$Thing$query.limit)
						}),
					token);
			case 'ProvisionThing':
				return _Utils_Tuple2(
					author$project$Thing$resetEdit(model),
					A6(
						author$project$HttpMF$provision,
						A2(
							elm$url$Url$Builder$relative,
						...
						token,
						_Utils_update(
							author$project$Thing$emptyThing,
							{
								metadata: author$project$JsonMF$stringToMaybeJsonValue(model.metadata),
								name: elm$core$Maybe$Just(model.name)
							}),
						author$project$Thing$thingEncoder,
						author$project$Thing$ProvisionedThing,
						'/things/'));
			case 'ProvisionedThing':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var thingid = result.a;
					return A2(
						author$project$Thing$updateThingList,
						_Utils_update(
							model,
			...
			case 'EditThing':
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							editMode: true,
							metadata: author$project$JsonMF$maybeJsonValueToString(model.thing.metadata),
							name: author$project$Helpers$parseString(model.thing.name)
						}),
					elm$core$Platform$Cmd$none);
			case 'UpdateThing':
				return _Utils_Tuple2(
					author$project$Thing$resetEdit(
						_Utils_update(
							model,
							{editMode: false})),
					A5(
							...
							author$project$Thing$emptyThing,
							{
								metadata: function () {
									...
									if (_n2.$ === 'Ok') {
										...
										var err = _n2.a;
										return model.thing.metadata;
									}
								}(),
								name: elm$core$Maybe$Just(model.name)
							}),
						author$project$Thing$thingEncoder,
						author$project$Thing$UpdatedThing));
			case 'UpdatedThing':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var statusCode = result.a;
				...
				return _Utils_Tuple2(
					...
					A4(
						...
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.things, thingid]),
							_List_Nil),
						token,
						author$project$Thing$RetrievedThing,
						author$project$Thing$thingDecoder));
				...
				return _Utils_Tuple2(
					...
					A3(
						...
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.things, id]),
							_List_Nil),
						token,
						author$project$Thing$RemovedThing));
			case 'RemovedThing':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var statusCode = result.a;
					return A2(
						...
						_Utils_update(
							...
							{
								editModalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$hidden,
								offset: A3(author$project$Helpers$validateOffset, model.offset, model.things.total, author$project$Thing$query.limit),
								response: statusCode
							}),
						token);
				} else {
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{editModalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$shown, editMode: false, thing: thing}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Connection$update = F3(
	function (msg, model, token) {
		switch (msg.$) {
			case 'Connect':
				return author$project$Connection$isEmptyChecked(model) ? _Utils_Tuple2(model, elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					author$project$Connection$resetChecked(model),
					elm$core$Platform$Cmd$batch(
						A4(author$project$Connection$connect, model.checkedThingsIds, model.checkedChannelsIds, 'PUT', token)));
			case 'Disconnect':
				return author$project$Connection$isEmptyChecked(model) ? _Utils_Tuple2(model, elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					author$project$Connection$resetChecked(model),
					elm$core$Platform$Cmd$batch(
						A4(author$project$Connection$connect, model.checkedThingsIds, model.checkedChannelsIds, 'DELETE', token)));
			case 'GotResponse':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var statusCode = result.a;
			...
			case 'ThingMsg':
				var subMsg = msg.a;
				var _n2 = A3(author$project$Thing$update, subMsg, model.things, token);
				var updatedThing = _n2.a;
				var thingCmd = _n2.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{things: updatedThing}),
					A2(elm$core$Platform$Cmd$map, author$project$Connection$ThingMsg, thingCmd));
			case 'ChannelMsg':
				var subMsg = msg.a;
				var _n3 = A3(author$project$Channel$update, subMsg, model.channels, token);
				var updatedChannel = _n3.a;
				var channelCmd = _n3.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{channels: updatedChannel}),
					A2(elm$core$Platform$Cmd$map, author$project$Connection$ChannelMsg, channelCmd));
			case 'CheckThing':
				var thing = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							checkedThingsIds: A2(author$project$Helpers$checkEntity, thing.a, model.checkedThingsIds)
						}),
					elm$core$Platform$Cmd$none);
			default:
				var id = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							checkedChannelsIds: A2(author$project$Helpers$checkEntity, id, model.checkedChannelsIds)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Main$ConnectionMsg = function (a) {
	return {$: 'ConnectionMsg', a: a};
};
var author$project$Main$updateConnection = F2(
	function (model, msg) {
		var _n0 = A3(author$project$Connection$update, msg, model.connection, model.user.token);
		var updatedConnection = _n0.a;
		var connectionCmd = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{connection: updatedConnection}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$ConnectionMsg, connectionCmd));
	});
var author$project$Channel$RetrieveChannelsForThing = function (a) {
	return {$: 'RetrieveChannelsForThing', a: a};
};
var author$project$Helpers$wowzaCmd = {recStart: '[{"bn":"1:", "n":"control", "vs":"wowza-start-recording, _defaultServer_, _defaultVHost_, liveapp, liveapp, cam1.stream"}]', recStop: '[{"bn":"1:", "n":"control", "vs":"wowza-stop-recording, _defaultServer_, _defaultVHost_, liveapp, liveapp, cam1.stream"}]'};
var author$project$Message$SentMessage = function (a) {
	return {$: 'SentMessage', a: a};
};
var elm$http$Http$stringBody = _Http_pair;
var author$project$Message$send = F4(
	function (channelid, thingkey, message, subtopic) {
		return A5(
			author$project$HttpMF$request,
			A2(
				elm$url$Url$Builder$relative,
				_List_fromArray(
					['http', author$project$HttpMF$paths.channels, channelid, author$project$HttpMF$paths.messages, subtopic]),
				_List_Nil),
			'POST',
			thingkey,
			A2(elm$http$Http$stringBody, 'application/json', message),
			author$project$Message$SentMessage);
	});
var author$project$Message$ChannelMsg = function (a) {
	return {$: 'ChannelMsg', a: a};
};
var author$project$Message$updateChannel = F3(
	function (model, msg, token) {
		var _n0 = A3(author$project$Channel$update, msg, model.channels, token);
		var updatedChannel = _n0.a;
		var channelCmd = _n0.b;
		var checkedChannels = updatedChannel.channels.list;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{channels: updatedChannel}),
			A2(elm$core$Platform$Cmd$map, author$project$Message$ChannelMsg, channelCmd));
	});
var author$project$Message$ThingMsg = function (a) {
	return {$: 'ThingMsg', a: a};
};
var author$project$Message$updateThing = F3(
	function (model, msg, token) {
		var _n0 = A3(author$project$Thing$update, msg, model.things, token);
		var updatedThing = _n0.a;
		var thingCmd = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{things: updatedThing}),
			A2(elm$core$Platform$Cmd$map, author$project$Message$ThingMsg, thingCmd));
	});
var author$project$Ports$Websocket = F3(
	function (channelid, thingkey, message) {
		return {channelid: channelid, message: message, thingkey: thingkey};
	});
var author$project$Ports$websocketEncoder = function (ws) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'channelid',
				elm$json$Json$Encode$string(ws.channelid)),
				_Utils_Tuple2(
				'thingkey',
				elm$json$Json$Encode$string(ws.thingkey)),
				_Utils_Tuple2(
				'message',
				elm$json$Json$Encode$string(ws.message))
			]));
};
var author$project$Message$ws = F2(
	function (command, model) {
		return A2(
			elm$core$List$map,
			function (channelid) {
				return command(
					author$project$Ports$websocketEncoder(
						A3(author$project$Ports$Websocket, channelid, model.thingkey, '')));
			},
			model.checkedChannelsIds);
	});
var author$project$Ports$channelIdFromUrl = function (url) {
	var start = elm$core$String$length('wss://localhost/ws/channels/');
	var end = elm$core$String$length('wss://localhost/ws/channels/') + elm$core$String$length('0522c54b-5b00-4aab-a2b0-6e3e54320995');
	return A3(elm$core$String$slice, start, end, url);
};
var author$project$Ports$connectWebsocket = _Platform_outgoingPort('connectWebsocket', elm$core$Basics$identity);
var author$project$Ports$disconnectWebsocket = _Platform_outgoingPort('disconnectWebsocket', elm$core$Basics$identity);
var author$project$Ports$WebsocketQuery = F2(
	function (url, readyState) {
		return {readyState: readyState, url: url};
	});
var author$project$Ports$websocketQueryDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Ports$WebsocketQuery,
	A2(elm$json$Json$Decode$field, 'url', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'readyState', elm$json$Json$Decode$int));
var author$project$Ports$websocketsQueryDecoder = elm$json$Json$Decode$list(author$project$Ports$websocketQueryDecoder);
var elm$json$Json$Decode$decodeValue = _Json_run;
var author$project$Message$update = F3(
	function (msg, model, token) {
		switch (msg.$) {
			case 'SubmitMessage':
				var message = msg.a;
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$batch(
						A2(
							elm$core$List$map,
							function (channelid) {
								return A4(author$project$Message$send, channelid, model.thingkey, author$project$Helpers$wowzaCmd.recStart, author$project$HttpMF$paths.req);
							},
							model.checkedChannelsIds)));
			case 'StopRecording':
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$batch(
						A2(
							elm$core$List$map,
							function (channelid) {
								return A4(author$project$Message$send, channelid, model.thingkey, author$project$Helpers$wowzaCmd.recStop, author$project$HttpMF$paths.req);
							},
							model.checkedChannelsIds)));
			case 'SendMessage':
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$batch(
						A2(
							elm$core$List$map,
							function (channelid) {
								return A4(author$project$Message$send, channelid, model.thingkey, model.message, '');
							},
							model.checkedChannelsIds)));
			case 'Listen':
				return elm$core$List$isEmpty(model.checkedChannelsIds) ? _Utils_Tuple2(model, elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					model,
					elm$core$Platform$Cmd$batch(
						A2(author$project$Message$ws, author$project$Ports$connectWebsocket, model)));
			case 'Stop':
				return elm$core$List$isEmpty(model.checkedChannelsIds) ? _Utils_Tuple2(model, elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					model,
					elm$core$Platform$Cmd$batch(
						A2(author$project$Message$ws, author$project$Ports$disconnectWebsocket, model)));
			case 'SentMessage':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var statusCode = result.a;
			...
			case 'WebsocketIn':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							websocketIn: A2(elm$core$List$cons, data, model.websocketIn)
						}),
					elm$core$Platform$Cmd$none);
			case 'RetrievedWebsockets':
				var wssList = msg.a;
				var _n2 = A2(elm$json$Json$Decode$decodeValue, author$project$Ports$websocketsQueryDecoder, wssList);
				if (_n2.$ === 'Ok') {
					var wssL = _n2.a;
					if (elm$core$List$isEmpty(wssL)) {
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					} else {
						var l = A2(
							elm$core$List$map,
							function (wss) {
								return author$project$Ports$channelIdFromUrl(wss.url);
							},
							wssL);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{checkedChannelsIdsWs: l}),
							elm$core$Platform$Cmd$none);
					}
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			...
			case 'ThingMsg':
				var subMsg = msg.a;
				return A3(author$project$Message$updateThing, model, subMsg, token);
			case 'ChannelMsg':
				var subMsg = msg.a;
				return A3(author$project$Message$updateChannel, model, subMsg, token);
			case 'SelectThing':
				var thingid = msg.a;
				var thingkey = msg.b;
				var channelMsg = msg.c;
				return A3(
					author$project$Message$updateChannel,
					_Utils_update(
						model,
						{checkedChannelsIds: _List_Nil, checkedChannelsIdsWs: _List_Nil, thingid: thingid, thingkey: thingkey}),
					author$project$Channel$RetrieveChannelsForThing(thingid),
					token);
			default:
				var id = msg.a;
				return _Utils_Tuple2(
...
var author$project$Main$updateMessage = F2(
	function (model, msg) {
		var _n0 = A3(author$project$Message$update, msg, model.message, model.user.token);
		var updatedMessage = _n0.a;
		var messageCmd = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{message: updatedMessage}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$MessageMsg, messageCmd));
	});
var author$project$Main$ThingMsg = function (a) {
	return {$: 'ThingMsg', a: a};
};
var author$project$Main$updateThing = F2(
	function (model, msg) {
		var _n0 = A3(author$project$Thing$update, msg, model.thing, model.user.token);
		var updatedThing = _n0.a;
		var thingCmd = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{thing: updatedThing}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$ThingMsg, thingCmd));
	});
var author$project$Main$VersionMsg = function (a) {
	return {$: 'VersionMsg', a: a};
};
...
var author$project$HttpMF$version = F3(
	function (path, msg, decoder) {
...
var author$project$Version$GotVersion = function (a) {
	return {$: 'GotVersion', a: a};
};
var author$project$Version$update = F2(
	function (msg, model) {
		if (msg.$ === 'GetVersion') {
			return _Utils_Tuple2(
				model,
				A3(
					author$project$HttpMF$version,
					A2(
						elm$url$Url$Builder$relative,
						_List_fromArray(
							[author$project$HttpMF$paths.version]),
						_List_Nil),
					author$project$Version$GotVersion,
			...
			if (result.$ === 'Ok') {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							version: author$project$Error$handle(error)
						}),
					elm$core$Platform$Cmd$none);
			}
		}
	});
var author$project$Main$logIn = F5(
	function (model, user, dashboardMsg, thingMsg, channelMsg) {
		var _n0 = A3(author$project$Thing$update, thingMsg, model.thing, user.token);
		var updatedThing = _n0.a;
		var thingCmd = _n0.b;
		var _n1 = A2(author$project$Version$update, dashboardMsg, model.dashboard);
		var updatedVersion = _n1.a;
		var dashboardCmd = _n1.b;
		var _n2 = A3(author$project$Channel$update, channelMsg, model.channel, user.token);
		var updatedChannel = _n2.a;
		var channelCmd = _n2.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{user: user}),
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2(elm$core$Platform$Cmd$map, author$project$Main$VersionMsg, dashboardCmd),
						A2(elm$core$Platform$Cmd$map, author$project$Main$ThingMsg, thingCmd),
						A2(elm$core$Platform$Cmd$map, author$project$Main$ChannelMsg, channelCmd)
					])));
	});
var author$project$Thing$RetrieveThings = {$: 'RetrieveThings'};
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{body: r.body, expect: r.expect, headers: _List_Nil, method: 'POST', timeout: elm$core$Maybe$Nothing, tracker: elm$core$Maybe$Nothing, url: r.url});
};
var author$project$HttpMF$user = F5(
	function (email, password, u, value, expect) {
		return elm$http$Http$post(
			{
				body: elm$http$Http$jsonBody(value),
				expect: expect,
				url: _Utils_ap(author$project$HttpMF$baseURL, u)
			});
	});
var author$project$User$Created = function (a) {
	return {$: 'Created', a: a};
};
var author$project$User$GotToken = function (a) {
	return {$: 'GotToken', a: a};
};
var author$project$User$User = F2(
		...
		switch (msg.$) {
			...
			case 'Create':
				return _Utils_Tuple2(
					model,
					A5(
						author$project$HttpMF$user,
						model.email,
						model.password,
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.users]),
							_List_Nil),
						author$project$User$encode(
							A2(author$project$User$User, model.email, model.password)),
						author$project$HttpMF$expectStatus(author$project$User$Created)));
			case 'Created':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var statusCode = result.a;
				...
				return _Utils_Tuple2(
					...
					A5(
						...
						A2(
							elm$url$Url$Builder$relative,
							_List_fromArray(
								[author$project$HttpMF$paths.tokens]),
							_List_Nil),
						author$project$User$encode(
							A2(author$project$User$User, model.email, model.password)),
						A2(
							author$project$HttpMF$expectRetrieve,
							author$project$User$GotToken,
...
var author$project$Version$GetVersion = {$: 'GetVersion'};
var author$project$Main$updateUser = F2(
	function (model, msg) {
		var _n0 = A2(author$project$User$update, msg, model.user);
		var updatedUser = _n0.a;
		var userCmd = _n0.b;
		if (msg.$ === 'GotToken') {
			return (elm$core$String$length(updatedUser.token) > 0) ? A5(
				author$project$Main$logIn,
				_Utils_update(
					model,
					{view: 'dashboard'}),
				updatedUser,
				author$project$Version$GetVersion,
				author$project$Thing$RetrieveThings,
				author$project$Channel$RetrieveChannels) : _Utils_Tuple2(
				_Utils_update(
					model,
					{user: updatedUser}),
...
var author$project$Main$updateVersion = F2(
	function (model, msg) {
		var _n0 = A2(author$project$Version$update, msg, model.dashboard);
		var updatedVersion = _n0.a;
		var dashboardCmd = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{dashboard: updatedVersion}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$VersionMsg, dashboardCmd));
	});
			...
			case 'UrlChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							view: author$project$Main$parse(url)
						}),
					elm$core$Platform$Cmd$none);
			case 'UserMsg':
				var subMsg = msg.a;
				return A2(author$project$Main$updateUser, model, subMsg);
			case 'VersionMsg':
				var subMsg = msg.a;
				return A2(author$project$Main$updateVersion, model, subMsg);
			case 'ChannelMsg':
				var subMsg = msg.a;
				return A2(author$project$Main$updateChannel, model, subMsg);
			case 'ThingMsg':
				var subMsg = msg.a;
				return A2(author$project$Main$updateThing, model, subMsg);
			case 'ConnectionMsg':
				var subMsg = msg.a;
				return A2(author$project$Main$updateConnection, model, subMsg);
			case 'MessageMsg':
				var subMsg = msg.a;
				return A2(author$project$Main$updateMessage, model, subMsg);
			case 'Version':
				return _Utils_Tuple2(
					_Utils_update(
						model,
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A2(
								author$project$Main$updateConnection,
								model,
								author$project$Connection$ThingMsg(author$project$Thing$RetrieveThings)).b,
								A2(
								author$project$Main$updateConnection,
								model,
								author$project$Connection$ChannelMsg(author$project$Channel$RetrieveChannels)).b
							])));
			default:
				return A2(
					author$project$Main$updateMessage,
					_Utils_update(
						model,
						{view: 'messages'}),
					author$project$Message$ThingMsg(author$project$Thing$RetrieveThings));
		}
	});
var author$project$Channel$ShowProvisionModal = {$: 'ShowProvisionModal'};
var author$project$Channel$SubmitPage = function (a) {
	return {$: 'SubmitPage', a: a};
};
var author$project$Channel$CloseEditModal = {$: 'CloseEditModal'};
var author$project$Channel$EditChannel = {$: 'EditChannel'};
var author$project$Channel$RemoveChannel = function (a) {
	return {$: 'RemoveChannel', a: a};
};
var author$project$Channel$ShowEditModal = function (a) {
	return {$: 'ShowEditModal', a: a};
};
var author$project$Channel$UpdateChannel = {$: 'UpdateChannel'};
var author$project$Channel$SubmitMetadata = function (a) {
	return {$: 'SubmitMetadata', a: a};
};
var author$project$Channel$SubmitName = function (a) {
	return {$: 'SubmitName', a: a};
};
var author$project$ModalMF$FormRecord = F4(
	function (text, msg, placeholder, value) {
		return {msg: msg, placeholder: placeholder, text: text, value: value};
	});
...
var author$project$ModalMF$modalDiv = function (paragraphList) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		A2(
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text(paragraph.a + ': ')
								])),
							elm$html$Html$text(paragraph.b)
						]));
			},
			paragraphList));
};
...
var author$project$ModalMF$modalForm = function (formList) {
	return A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$text(form.text)
										]))
								])),
							rundis$elm_bootstrap$Bootstrap$Form$Input$text(
							_List_fromArray(
								[
									rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(form.msg),
									rundis$elm_bootstrap$Bootstrap$Form$Input$attrs(
									_List_fromArray(
										[
											elm$html$Html$Attributes$placeholder(form.placeholder),
											elm$html$Html$Attributes$value(form.value)
										]))
								]))
						]));
			},
...
var author$project$Channel$editModalForm = function (model) {
	return model.editMode ? author$project$ModalMF$modalForm(
		_List_fromArray(
			[
				A4(
				author$project$ModalMF$FormRecord,
				'name',
				author$project$Channel$SubmitName,
				author$project$Helpers$parseString(model.channel.name),
				model.name),
				A4(
				author$project$ModalMF$FormRecord,
				'metadata',
				author$project$Channel$SubmitMetadata,
				author$project$JsonMF$maybeJsonValueToString(model.channel.metadata),
				model.metadata)
			])) : author$project$ModalMF$modalDiv(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'name',
...
var author$project$ModalMF$button = F3(
	function (type_, msg, txt) {
		return A2(
...
var author$project$ModalMF$editModalButtons = F6(
	function (mode, updateMsg, editMsg, cancelMsg, deleteMsg, closeMsg) {
		var lButton2 = mode ? A3(author$project$ModalMF$button, rundis$elm_bootstrap$Bootstrap$Button$outlineDanger, cancelMsg, 'CANCEL') : A3(author$project$ModalMF$button, rundis$elm_bootstrap$Bootstrap$Button$outlineDanger, deleteMsg, 'DELETE');
		var lButton1 = mode ? A3(author$project$ModalMF$button, rundis$elm_bootstrap$Bootstrap$Button$outlinePrimary, updateMsg, 'UPDATE') : A3(author$project$ModalMF$button, rundis$elm_bootstrap$Bootstrap$Button$outlinePrimary, editMsg, 'EDIT');
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3(author$project$ModalMF$button, rundis$elm_bootstrap$Bootstrap$Button$outlineSecondary, closeMsg, 'CLOSE')
						]))
				]));
	});
...
var author$project$Channel$editModalBody = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Modal$body,
		_List_Nil,
		_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										author$project$Channel$editModalForm(model),
										author$project$ModalMF$modalDiv(
										_List_fromArray(
											[
												_Utils_Tuple2('id', model.channel.id)
											]))
									]))
							])),
						A6(
						author$project$ModalMF$editModalButtons,
						model.editMode,
						author$project$Channel$UpdateChannel,
						author$project$Channel$EditChannel,
						author$project$Channel$ShowEditModal(model.channel),
						author$project$Channel$RemoveChannel(model.channel.id),
						author$project$Channel$CloseEditModal)
					]))
			]));
};
...
var author$project$Channel$editModal = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Modal$view,
		model.editModalVisibility,
		A2(
			author$project$Channel$editModalBody,
			model,
			A3(
				...
				A2(
					...
					rundis$elm_bootstrap$Bootstrap$Modal$large(
						rundis$elm_bootstrap$Bootstrap$Modal$config(author$project$Channel$CloseEditModal))))));
};
...
var author$project$Channel$genTableBody = function (model) {
	return A2(
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							elm$html$Html$Events$onClick(
								author$project$Channel$ShowEditModal(channel)))
						]),
					_List_fromArray(
						[
							A2(
...
var author$project$Channel$genTableHeader = rundis$elm_bootstrap$Bootstrap$Table$simpleThead(
	_List_fromArray(
		[
			A2(
...
var author$project$Channel$ClosePorvisionModal = {$: 'ClosePorvisionModal'};
var author$project$Channel$ProvisionChannel = {$: 'ProvisionChannel'};
var author$project$ModalMF$provisionModalButtons = F2(
	function (provisionMsg, closeMsg) {
		return A2(
			rundis$elm_bootstrap$Bootstrap$Grid$row,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3(author$project$ModalMF$button, rundis$elm_bootstrap$Bootstrap$Button$outlinePrimary, provisionMsg, 'ADD')
						])),
					A2(
					rundis$elm_bootstrap$Bootstrap$Grid$col,
					_List_fromArray(
...
var author$project$Channel$provisionModalBody = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Modal$body,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$ModalMF$modalForm(
						_List_fromArray(
							[
								A4(author$project$ModalMF$FormRecord, 'name', author$project$Channel$SubmitName, model.name, model.name),
								A4(author$project$ModalMF$FormRecord, 'metadata', author$project$Channel$SubmitMetadata, model.metadata, model.metadata)
							])),
						A2(author$project$ModalMF$provisionModalButtons, author$project$Channel$ProvisionChannel, author$project$Channel$ClosePorvisionModal)
					]))
			]));
};
var author$project$Channel$provisionModal = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Modal$view,
		model.provisionModalVisibility,
		A2(
			author$project$Channel$provisionModalBody,
			model,
			A3(
				rundis$elm_bootstrap$Bootstrap$Modal$h4,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Add channel')
					]),
				A2(
					rundis$elm_bootstrap$Bootstrap$Modal$hideOnBackdropClick,
					true,
					rundis$elm_bootstrap$Bootstrap$Modal$large(
						rundis$elm_bootstrap$Bootstrap$Modal$config(author$project$Channel$ClosePorvisionModal))))));
};
var author$project$Helpers$appendIf = F3(
	function (flag, list, value) {
		return flag ? _Utils_ap(
			list,
			_List_fromArray(
				[value])) : list;
	});
var author$project$Helpers$faIcons = {channels: 'fas fa-broadcast-tower', connection: 'fas fa-plug', dashboard: 'fas fa-chart-bar', edit: 'fa fa-pen', messages: 'far fa-paper-plane', provision: 'fa fa-plus', receive: 'fas fa-arrow-down', remove: 'fa fa-trash-alt', send: 'fas fa-arrow-up', things: 'fas fa-sitemap', version: 'fa fa-code-branch', websocket: 'fas fa-arrows-alt-v'};
var author$project$Helpers$disableNext = F2(
	function (currPage, total) {
		return _Utils_eq(
			currPage,
			elm$core$Basics$ceiling(total / 10));
	});
...
var author$project$Helpers$genPagination = F3(
	function (total, currPage, msg) {
		var pages = A2(
			elm$core$List$range,
			1,
			elm$core$Basics$ceiling(total / 10));
									...
									[
										...
										_List_fromArray(
											[
												...
												_Utils_Tuple2('disabled', currPage === 1)
											]))
									]),
								_List_fromArray(
									[
										...
										elm$html$Html$a,
										A3(
											author$project$Helpers$appendIf,
											currPage > 1,
											_List_fromArray(
												[
										...
										[
											...
											_List_fromArray(
												[
													...
													_Utils_Tuple2(
													'disabled',
													A2(author$project$Helpers$disableNext, currPage, total))
												]))
										]),
									_List_fromArray(
										[
...
var author$project$Helpers$offsetToPage = F2(
	function (offset, limit) {
...
var author$project$Channel$view = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Grid$container,
		_List_Nil,
		A3(
			author$project$Helpers$appendIf,
			_Utils_cmp(model.channels.total, model.limit) > 0,
			_List_fromArray(
				[
					A2(
					rundis$elm_bootstrap$Bootstrap$Grid$row,
												...
												rundis$elm_bootstrap$Bootstrap$Table$table(
													{
														...
														tbody: author$project$Channel$genTableBody(model),
														thead: author$project$Channel$genTableHeader
													}))
											]),
										A3(
											rundis$elm_bootstrap$Bootstrap$Card$header,
																...
																[
																	...
																	_List_fromArray(
																		[
																			...
																			_List_fromArray(
																				[
																					elm$html$Html$Attributes$class('table_header')
																				]),
																			_List_fromArray(
																				[
																					A2(
																					...
																					_List_fromArray(
																						[
																							...
																							elm$html$Html$Attributes$class(author$project$Helpers$faIcons.channels)
																						]),
																					_List_Nil),
																...
																[
																	...
																	_List_fromArray(
																		[
																			...
																			rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Channel$ShowProvisionModal)
																		]),
																	_List_fromArray(
																		[
					...
					author$project$Channel$provisionModal(model),
					author$project$Channel$editModal(model)
				]),
			A3(
				author$project$Helpers$genPagination,
				model.channels.total,
				A2(author$project$Helpers$offsetToPage, model.offset, model.limit),
				author$project$Channel$SubmitPage)));
};
var author$project$Connection$Connect = {$: 'Connect'};
var author$project$Connection$Disconnect = {$: 'Disconnect'};
var author$project$Connection$CheckChannel = function (a) {
	return {$: 'CheckChannel', a: a};
};
var author$project$Helpers$isChecked = F2(
	function (id, checkedEntitiesIds) {
		return A2(elm$core$List$member, id, checkedEntitiesIds) ? true : false;
	});
var elm$html$Html$Attributes$checked = elm$html$Html$Attributes$boolProperty('checked');
var author$project$Connection$genChannelRows = F2(
	function (checkedChannelsIds, channels) {
		return A2(
			elm$core$List$map,
			function (channel) {
				return A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											elm$html$Html$Events$onClick(
											author$project$Connection$CheckChannel(channel.id)),
											elm$html$Html$Attributes$checked(
											A2(author$project$Helpers$isChecked, channel.id, checkedChannelsIds))
										]),
									_List_Nil)
								]))
						]));
...
var author$project$Connection$CheckThing = function (a) {
	return {$: 'CheckThing', a: a};
};
var author$project$Connection$genThingRows = F2(
	function (checkedThingsIds, things) {
		return A2(
			elm$core$List$map,
			function (thing) {
				return A2(
								...
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$type_('checkbox'),
											elm$html$Html$Events$onClick(
											author$project$Connection$CheckThing(
												_Utils_Tuple2(thing.id, thing.key))),
											elm$html$Html$Attributes$checked(
											A2(author$project$Helpers$isChecked, thing.id, checkedThingsIds))
										]),
									_List_Nil)
								]))
						]));
...
var author$project$Helpers$genCardConfig = F3(
	function (faClass, title, rows) {
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A2(elm$html$Html$Attributes$style, 'margin-right', '15px'),
											elm$html$Html$Attributes$class(faClass)
										]),
									_List_Nil),
...
var author$project$Helpers$response = function (resp) {
	return (elm$core$String$length(resp) > 0) ? A2(
		rundis$elm_bootstrap$Bootstrap$Grid$row,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('response: ' + resp)
							]))
					]))
			])) : A2(
		rundis$elm_bootstrap$Bootstrap$Grid$row,
...
var author$project$Thing$SubmitPage = function (a) {
	return {$: 'SubmitPage', a: a};
};
...
var author$project$Connection$view = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Grid$container,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						A3(
							author$project$Helpers$appendIf,
							_Utils_cmp(model.things.things.total, model.things.limit) > 0,
							_List_fromArray(
								[
									A3(
									author$project$Helpers$genCardConfig,
									author$project$Helpers$faIcons.things,
									'Things',
									A2(author$project$Connection$genThingRows, model.checkedThingsIds, model.things.things.list))
								]),
							A2(
								elm$html$Html$map,
								author$project$Connection$ThingMsg,
								A3(
									author$project$Helpers$genPagination,
									model.things.things.total,
									A2(author$project$Helpers$offsetToPage, model.things.offset, model.things.limit),
									author$project$Thing$SubmitPage)))),
						A2(
						rundis$elm_bootstrap$Bootstrap$Grid$col,
						_List_Nil,
						A3(
							author$project$Helpers$appendIf,
							_Utils_cmp(model.channels.channels.total, model.channels.limit) > 0,
							_List_fromArray(
								[
									A3(
									author$project$Helpers$genCardConfig,
									author$project$Helpers$faIcons.channels,
									'Channels',
									A2(author$project$Connection$genChannelRows, model.checkedChannelsIds, model.channels.channels.list))
								]),
							A2(
								elm$html$Html$map,
								author$project$Connection$ChannelMsg,
								A3(
									author$project$Helpers$genPagination,
									model.channels.channels.total,
									A2(author$project$Helpers$offsetToPage, model.channels.offset, model.channels.limit),
									author$project$Channel$SubmitPage))))
					])),
				A2(
				rundis$elm_bootstrap$Bootstrap$Grid$row,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml1])),
												rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Connection$Connect)
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml1])),
												rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Connection$Disconnect)
											]),
										_List_fromArray(
											[
				...
				author$project$Helpers$response(model.response)
			]));
};
...
var author$project$Helpers$fontAwesome = A3(
	elm$html$Html$node,
	'link',
	_List_fromArray(
		[
			elm$html$Html$Attributes$rel('stylesheet'),
			elm$html$Html$Attributes$href('https://use.fontawesome.com/releases/v5.7.2/css/all.css'),
			A2(elm$html$Html$Attributes$attribute, 'integrity', 'sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr'),
			A2(elm$html$Html$Attributes$attribute, 'crossorigin', 'anonymous')
		]),
	_List_Nil);
var author$project$Main$Channels = {$: 'Channels'};
var author$project$Main$Connection = {$: 'Connection'};
var author$project$Main$Messages = {$: 'Messages'};
var author$project$Main$Things = {$: 'Things'};
var author$project$Main$Version = {$: 'Version'};
...
var author$project$Main$cardList = function (model) {
	return _List_fromArray(
		[
			A3(
			rundis$elm_bootstrap$Bootstrap$Card$block,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(model.dashboard.version)
						]))
				]),
			A3(
				rundis$elm_bootstrap$Bootstrap$Card$headerH3,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2(elm$html$Html$Attributes$style, 'margin-right', '15px'),
										elm$html$Html$Attributes$class(author$project$Helpers$faIcons.version)
									]),
								_List_Nil),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							elm$core$String$fromInt(model.thing.things.total))
						])),
					rundis$elm_bootstrap$Bootstrap$Card$Block$custom(
					A2(
						rundis$elm_bootstrap$Bootstrap$Button$button,
						_List_fromArray(
							[
								rundis$elm_bootstrap$Bootstrap$Button$secondary,
								rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Main$Things)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Manage things')
							])))
				]),
			A3(
				rundis$elm_bootstrap$Bootstrap$Card$headerH3,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2(elm$html$Html$Attributes$style, 'margin-right', '15px'),
										elm$html$Html$Attributes$class(author$project$Helpers$faIcons.things)
									]),
								_List_Nil),
								elm$html$Html$text('Things')
							]))
					]),
				rundis$elm_bootstrap$Bootstrap$Card$config(_List_Nil))),
			A3(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							elm$core$String$fromInt(model.channel.channels.total))
						])),
					rundis$elm_bootstrap$Bootstrap$Card$Block$custom(
					A2(
						rundis$elm_bootstrap$Bootstrap$Button$button,
						_List_fromArray(
							[
								rundis$elm_bootstrap$Bootstrap$Button$secondary,
								rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Main$Channels)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Manage channels')
							])))
				]),
			A3(
				rundis$elm_bootstrap$Bootstrap$Card$headerH3,
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rundis$elm_bootstrap$Bootstrap$Card$deck(
								author$project$Main$cardList(model))
							]))
					]))
			]));
};
var author$project$Main$menuItem = F4(
	function (name, msg, icon, active) {
		return A2(
			elm$html$Html$li,
			_List_fromArray(
				[
...
var author$project$Main$mfStylesheet = A3(
	elm$html$Html$node,
	'link',
	_List_fromArray(
		[
			elm$html$Html$Attributes$rel('stylesheet'),
			elm$html$Html$Attributes$href('./css/mainflux.css')
		]),
	_List_Nil);
var elm$html$Html$ol = _VirtualDom_node('ol');
var author$project$Helpers$genOrderedList = function (strings) {
	return A2(
		elm$html$Html$ol,
		_List_Nil,
		A2(
...
var author$project$Message$Listen = {$: 'Listen'};
var author$project$Message$SendMessage = {$: 'SendMessage'};
var author$project$Message$StartRecording = {$: 'StartRecording'};
var author$project$Message$Stop = {$: 'Stop'};
var author$project$Message$StopRecording = {$: 'StopRecording'};
var author$project$Message$SubmitMessage = function (a) {
	return {$: 'SubmitMessage', a: a};
};
var author$project$Message$CheckChannel = function (a) {
	return {$: 'CheckChannel', a: a};
};
var author$project$Message$isInList = F2(
	function (id, idList) {
		return A2(elm$core$List$member, id, idList) ? ' *WS*' : '';
	});
var author$project$Message$genChannelRows = function (model) {
	return A2(
		elm$core$List$map,
		function (channel) {
			return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_Utils_ap(
									channel.id,
									A2(author$project$Message$isInList, channel.id, model.checkedChannelsIdsWs)))
							])),
						A2(
						rundis$elm_bootstrap$Bootstrap$Table$td,
						_List_Nil,
							...
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$type_('checkbox'),
										elm$html$Html$Events$onClick(
										author$project$Message$CheckChannel(channel.id)),
										elm$html$Html$Attributes$checked(
										A2(author$project$Helpers$isChecked, channel.id, model.checkedChannelsIds))
									]),
								_List_Nil)
							]))
					]));
...
var author$project$Message$SelectThing = F3(
	function (a, b, c) {
		return {$: 'SelectThing', a: a, b: b, c: c};
	});
var elm$html$Html$Attributes$name = elm$html$Html$Attributes$stringProperty('name');
var author$project$Message$genThingRows = function (model) {
	return A2(
		elm$core$List$map,
		function (thing) {
			return A2(
								...
								_List_fromArray(
									[
										...
										A3(
											...
											thing.id,
											thing.key,
											author$project$Channel$RetrieveChannelsForThing(thing.id))),
										elm$html$Html$Attributes$name('things')
									]),
								_List_Nil)
							]))
					]));
						...
						A3(
							...
							_List_fromArray(
								[
									...
									author$project$Helpers$faIcons.things,
									'Things',
									author$project$Message$genThingRows(model))
								]),
							A2(
								elm$html$Html$map,
								author$project$Message$ThingMsg,
								A3(
									author$project$Helpers$genPagination,
									model.things.things.total,
									A2(author$project$Helpers$offsetToPage, model.things.offset, model.things.limit),
						...
						A3(
							...
							_List_fromArray(
								[
									...
									author$project$Helpers$faIcons.channels,
									'Channels',
									author$project$Message$genChannelRows(model))
								]),
							A2(
								elm$html$Html$map,
								author$project$Message$ChannelMsg,
								A3(
									author$project$Helpers$genPagination,
									model.channels.channels.total,
									A2(author$project$Helpers$offsetToPage, model.channels.offset, model.channels.limit),
													...
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		rundis$elm_bootstrap$Bootstrap$Form$Input$id('message'),
																		rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(author$project$Message$SubmitMessage)
																	]))
															]))
													])))
										]),
																...
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				A2(elm$html$Html$Attributes$style, 'margin-right', '15px'),
																				elm$html$Html$Attributes$class(author$project$Helpers$faIcons.send)
																			]),
																		_List_Nil),
																	...
																	[
																		...
																		_List_fromArray(
																			[
																				...
																				_List_fromArray(
																					[rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml1])),
																				rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Message$StartRecording)
																			]),
																		_List_fromArray(
																			[
																		...
																		_List_fromArray(
																			[
																				...
																				_List_fromArray(
																					[rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml1])),
																				rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Message$StopRecording)
																			]),
																		_List_fromArray(
																			[
																		...
																		_List_fromArray(
																			[
																				...
																				_List_fromArray(
																					[rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml1])),
																				rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Message$SendMessage)
																			]),
																		_List_fromArray(
																			[
							...
							[
								...
								A3(
									...
									_List_fromArray(
										[
											rundis$elm_bootstrap$Bootstrap$Card$Block$custom(
											author$project$Helpers$genOrderedList(model.websocketIn))
										]),
									A3(
										rundis$elm_bootstrap$Bootstrap$Card$headerH3,
										_List_Nil,
																...
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				A2(elm$html$Html$Attributes$style, 'margin-right', '15px'),
																				elm$html$Html$Attributes$class(author$project$Helpers$faIcons.receive)
																			]),
																		_List_Nil),
																		elm$html$Html$text('WS')
																	]))
															])),
														A2(
														rundis$elm_bootstrap$Bootstrap$Grid$col,
																			...
																			[
																				...
																				_List_fromArray(
																					[
																						...
																						_List_fromArray(
																							[rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml1])),
																						rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Message$Listen)
																					]),
																				_List_fromArray(
																					[
																						elm$html$Html$text('Listen')
																					])),
																				A2(
																				rundis$elm_bootstrap$Bootstrap$Button$button,
																				_List_fromArray(
																					[
																						...
																						_List_fromArray(
																							[rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml1])),
																						rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Message$Stop)
																					]),
																				_List_fromArray(
																					[
																						elm$html$Html$text('Stop')
...
var author$project$Thing$CloseEditModal = {$: 'CloseEditModal'};
var author$project$Thing$EditThing = {$: 'EditThing'};
var author$project$Thing$RemoveThing = function (a) {
	return {$: 'RemoveThing', a: a};
};
var author$project$Thing$ShowEditModal = function (a) {
	return {$: 'ShowEditModal', a: a};
};
var author$project$Thing$UpdateThing = {$: 'UpdateThing'};
var author$project$Thing$SubmitMetadata = function (a) {
	return {$: 'SubmitMetadata', a: a};
};
var author$project$Thing$SubmitName = function (a) {
	return {$: 'SubmitName', a: a};
};
var author$project$Thing$editModalForm = function (model) {
	return model.editMode ? author$project$ModalMF$modalForm(
		_List_fromArray(
			[
				A4(
				author$project$ModalMF$FormRecord,
				'name',
				author$project$Thing$SubmitName,
				author$project$Helpers$parseString(model.thing.name),
				model.name),
				A4(
				author$project$ModalMF$FormRecord,
				'metadata',
				author$project$Thing$SubmitMetadata,
				author$project$JsonMF$maybeJsonValueToString(model.thing.metadata),
				model.metadata)
			])) : author$project$ModalMF$modalDiv(
		_List_fromArray(
			[
...
var author$project$Thing$editModalBody = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Modal$body,
		_List_Nil,
		_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										author$project$Thing$editModalForm(model),
										author$project$ModalMF$modalDiv(
										_List_fromArray(
											[
												_Utils_Tuple2('id', model.thing.id),
												_Utils_Tuple2('key', model.thing.key)
											]))
									]))
							])),
						A6(
						author$project$ModalMF$editModalButtons,
						model.editMode,
						author$project$Thing$UpdateThing,
						author$project$Thing$EditThing,
						author$project$Thing$ShowEditModal(model.thing),
						author$project$Thing$RemoveThing(model.thing.id),
						author$project$Thing$CloseEditModal)
					]))
			]));
};
var author$project$Thing$editModal = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Modal$view,
		model.editModalVisibility,
		A2(
			author$project$Thing$editModalBody,
			model,
			A3(
				rundis$elm_bootstrap$Bootstrap$Modal$h4,
				_List_Nil,
				...
				A2(
					...
					true,
					rundis$elm_bootstrap$Bootstrap$Modal$large(
						rundis$elm_bootstrap$Bootstrap$Modal$config(author$project$Thing$CloseEditModal))))));
};
var author$project$Thing$ShowProvisionModal = {$: 'ShowProvisionModal'};
var author$project$Thing$genTableBody = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Table$tbody,
		_List_Nil,
		A2(
				...
				return A2(
					...
					_List_fromArray(
						[
							rundis$elm_bootstrap$Bootstrap$Table$rowAttr(
							elm$html$Html$Events$onClick(
								author$project$Thing$ShowEditModal(thing)))
						]),
					_List_fromArray(
						[
							A2(
...
var author$project$Thing$genTableHeader = rundis$elm_bootstrap$Bootstrap$Table$simpleThead(
	_List_fromArray(
		[
			A2(
			rundis$elm_bootstrap$Bootstrap$Table$th,
...
var author$project$Thing$genTable = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Grid$row,
		_List_Nil,
		_List_fromArray(
									...
									rundis$elm_bootstrap$Bootstrap$Table$table(
										{
											options: _List_fromArray(
												[rundis$elm_bootstrap$Bootstrap$Table$striped, rundis$elm_bootstrap$Bootstrap$Table$hover, rundis$elm_bootstrap$Bootstrap$Table$small]),
											tbody: author$project$Thing$genTableBody(model),
											thead: author$project$Thing$genTableHeader
										}))
								]),
							A3(
								rundis$elm_bootstrap$Bootstrap$Card$header,
													...
													[
														...
														_List_fromArray(
															[
																...
																rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Thing$ShowProvisionModal)
															]),
														_List_fromArray(
															[
																elm$html$Html$text('ADD')
...
var author$project$Thing$ClosePorvisionModal = {$: 'ClosePorvisionModal'};
var author$project$Thing$ProvisionThing = {$: 'ProvisionThing'};
var author$project$Thing$provisionModalForm = function (model) {
	return author$project$ModalMF$modalForm(
		_List_fromArray(
			[
				A4(author$project$ModalMF$FormRecord, 'name', author$project$Thing$SubmitName, model.name, model.name),
				A4(author$project$ModalMF$FormRecord, 'metadata', author$project$Thing$SubmitMetadata, model.metadata, model.metadata)
			]));
};
var author$project$Thing$provisionModalBody = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Modal$body,
		_List_Nil,
		_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										author$project$Thing$provisionModalForm(model)
									]))
							])),
						A2(author$project$ModalMF$provisionModalButtons, author$project$Thing$ProvisionThing, author$project$Thing$ClosePorvisionModal)
					]))
			]));
};
var author$project$Thing$provisionModal = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Modal$view,
		model.provisionModalVisibility,
		A2(
			author$project$Thing$provisionModalBody,
			model,
			A3(
				rundis$elm_bootstrap$Bootstrap$Modal$h4,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Add thing')
					]),
				A2(
					rundis$elm_bootstrap$Bootstrap$Modal$hideOnBackdropClick,
					true,
					rundis$elm_bootstrap$Bootstrap$Modal$large(
						rundis$elm_bootstrap$Bootstrap$Modal$config(author$project$Thing$ClosePorvisionModal))))));
};
var author$project$Thing$view = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Grid$container,
		_List_Nil,
		A3(
			author$project$Helpers$appendIf,
			_Utils_cmp(model.things.total, model.limit) > 0,
			_List_fromArray(
				[
					author$project$Thing$genTable(model),
					author$project$Thing$provisionModal(model),
					author$project$Thing$editModal(model)
				]),
			A3(
				author$project$Helpers$genPagination,
				model.things.total,
...
var author$project$User$loggedIn = function (model) {
	return (elm$core$String$length(model.token) > 0) ? true : false;
};
var author$project$User$Create = {$: 'Create'};
var author$project$User$GetToken = {$: 'GetToken'};
var author$project$User$LogOut = {$: 'LogOut'};
var author$project$User$SubmitEmail = function (a) {
	return {$: 'SubmitEmail', a: a};
};
var author$project$User$SubmitPassword = function (a) {
	return {$: 'SubmitPassword', a: a};
};
...
var author$project$User$view = function (model) {
	return author$project$User$loggedIn(model) ? A2(
		rundis$elm_bootstrap$Bootstrap$Grid$row,
		_List_Nil,
		_List_fromArray(
			[
						...
						model.dropState,
						{
							items: _List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Events$onClick(author$project$User$LogOut)
										]),
									_List_fromArray(
										[
							...
							toggleMsg: author$project$User$DropState
						})
					]))
			])) : A2(
		rundis$elm_bootstrap$Bootstrap$Grid$container,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														rundis$elm_bootstrap$Bootstrap$Form$Input$id('email'),
														rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(author$project$User$SubmitEmail)
													]))
											])),
										A2(
										rundis$elm_bootstrap$Bootstrap$Form$group,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														elm$html$Html$Attributes$for('pwd')
													]),
												_List_fromArray(
													[
												...
												_List_fromArray(
													[
														rundis$elm_bootstrap$Bootstrap$Form$Input$id('pwd'),
														rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(author$project$User$SubmitPassword)
													]))
											])),
										A2(
										rundis$elm_bootstrap$Bootstrap$Button$button,
										_List_fromArray(
											[
												...
												_List_fromArray(
													[rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml1])),
												rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$User$Create)
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml1])),
												rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$User$GetToken)
											]),
										_List_fromArray(
											[
...
var author$project$Main$view = function (model) {
	return {
		body: function () {
			var loggedIn = author$project$User$loggedIn(model.user);
			var menu = loggedIn ? _List_fromArray(
				[
					A2(
					elm$html$Html$ul,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('nav-pills flex-column nav')
						]),
					_List_fromArray(
						[
							A4(author$project$Main$menuItem, 'Dashboard', author$project$Main$Version, author$project$Helpers$faIcons.dashboard, model.view === 'dashboard'),
							A4(author$project$Main$menuItem, 'Things', author$project$Main$Things, author$project$Helpers$faIcons.things, model.view === 'things'),
							A4(author$project$Main$menuItem, 'Channels', author$project$Main$Channels, author$project$Helpers$faIcons.channels, model.view === 'channels'),
							A4(author$project$Main$menuItem, 'Connection', author$project$Main$Connection, author$project$Helpers$faIcons.connection, model.view === 'connection'),
							A4(author$project$Main$menuItem, 'Messages', author$project$Main$Messages, author$project$Helpers$faIcons.messages, model.view === 'messages')
						]))
				]) : _List_Nil;
			var header = loggedIn ? A2(
				elm$html$Html$map,
				author$project$Main$UserMsg,
				author$project$User$view(model.user)) : A2(rundis$elm_bootstrap$Bootstrap$Grid$container, _List_Nil, _List_Nil);
			var content = function () {
				if (loggedIn) {
					var _n0 = model.view;
					switch (_n0) {
						case 'dashboard':
							return author$project$Main$dashboard(model);
						case 'channels':
							return A2(
								elm$html$Html$map,
								author$project$Main$ChannelMsg,
								author$project$Channel$view(model.channel));
						case 'things':
							return A2(
								elm$html$Html$map,
								author$project$Main$ThingMsg,
								author$project$Thing$view(model.thing));
						case 'connection':
							return A2(
								elm$html$Html$map,
								author$project$Main$ConnectionMsg,
								author$project$Connection$view(model.connection));
						case 'messages':
							return A2(
								elm$html$Html$map,
								author$project$Main$MessageMsg,
								author$project$Message$view(model.message));
						default:
							return author$project$Main$dashboard(model);
					}
				} else {
					return A2(
						elm$html$Html$map,
						author$project$Main$UserMsg,
						author$project$User$view(model.user));
				}
			}();
			var buttonAttrs = rundis$elm_bootstrap$Bootstrap$Button$attrs(
				_List_fromArray(
					[
				...
				[
					...
					_List_fromArray(
						[
							...
							author$project$Main$mfStylesheet,
							author$project$Helpers$fontAwesome,
							A2(
							rundis$elm_bootstrap$Bootstrap$Grid$row,
							_List_fromArray(
								[
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													A2(elm$html$Html$Attributes$style, 'background-color', '#113f67'),
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													A2(rundis$elm_bootstrap$Bootstrap$Grid$col, _List_Nil, menu)
												]))
										])),
									A2(
									rundis$elm_bootstrap$Bootstrap$Grid$col,
